...
class PlayerController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $players = $em->getRepository('AdminBundle:Player')->findAll();
    ...
    {
        $player = new Player();
        $form = $this->createForm('AdminBundle\Form\PlayerType', $player);
    ...
    {
        $deleteForm = $this->createDeleteForm($player);
        $editForm = $this->createForm('AdminBundle\Form\PlayerType', $player);
