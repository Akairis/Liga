...
class SettingController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $settings = $em->getRepository('AdminBundle:Setting')->findAll();
    ...
    {
        $setting = new Setting();
        $form = $this->createForm('AdminBundle\Form\SettingType', $setting);
    ...
    {
        $deleteForm = $this->createDeleteForm($setting);
        $editForm = $this->createForm('AdminBundle\Form\SettingType', $setting);
